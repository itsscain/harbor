  ...
  return (
    <div className="rounded-2xl border border-water/30 bg-water/[0.04] p-4">
      <div className="flex items-center gap-2">
        ...
        <h2 className="text-title text-harbor">AI summary</h2>
      </div>
      {text ? (
      ...
      <button
        onClick={run}
        disabled={pending}
        className="mt-3 inline-flex items-center gap-2 rounded-xl bg-harbor px-4 py-2.5 text-sm font-semibold text-white shadow-button transition hover:bg-harbor-700 active:scale-[0.98] disabled:opacity-60"
      >
